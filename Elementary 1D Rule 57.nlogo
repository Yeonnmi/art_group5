...
to do-rule  ;; patch procedure
  ...
  ifelse ((left-pcolor = pink and center-pcolor = pink and right-pcolor = pink) or
  (left-pcolor = pink and center-pcolor = pink and right-pcolor = yellow) or
  (left-pcolor = yellow and center-pcolor = pink and right-pcolor = yellow) or
  (left-pcolor = yellow and center-pcolor = yellow and right-pcolor = pink))
